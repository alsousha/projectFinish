        ...
        <div className='userSection mb5'>
          <div className='top d-flex jcsb aic mb1'>
            ...
            <div className='userSection__btns d-flex'>
              <Link className='editBtn userSection__btn hover-scale link' to='profile'>
                <EditIcon className='sidebar__icon' />
              </Link>
              <span className='exitBtn userSection__btn hover-scale' onClick={logout}>
          ...
          <div className='bottom'>
            <div className='user__info d-flex f-column aic'>
              ...
              <div className='user__name t_24 t_bold'>
                <h3>
