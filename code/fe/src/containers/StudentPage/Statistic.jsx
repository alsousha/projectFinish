		...
		<div className='mt4 section_student_subjects'>
			<div className="container">
				...
				<div className="d-flex mt3 tab-list">
					{sbjs&&sbjs.map((item, i) => (
						<button key={"subject_studentStat"+item.id_subject} className={i===activeTab ? 'active tab-item' : 'tab-item'} onClick={() => handleSubjectClick(item.id_subject,i)}>
							{item.subject_name}
						</button>
					))}
				</div>
