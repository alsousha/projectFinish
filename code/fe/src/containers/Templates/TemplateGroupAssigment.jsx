...
function TemplateGroupAssigment({
  generalTaskData,
  handleMessage,
  message,
  setSelectedData,
  ...
  const validateField = (dataObject) => {
    ...
    if (generalTaskData.newItemName === '') {
      ...
      groupAssigmentData.leftBoxTitle.trim() === '' ||
      groupAssigmentData.rightBoxITitle.trim() === ''
    ) {
      msg.msgClass = 'error';
  ...
  const inputElementsLeft = groupAssigmentData.leftBoxItems
    ? Object.entries(groupAssigmentData.leftBoxItems).map(([index, value]) => (
    ...
    : null;
  //   const inputElementsRight = Object.entries(groupAssigmentData.rightBoxItems).map(
  //     ([index, value]) => (
  ...
  //         />
  //         <button className='ml1' onClick={() => handleDelRightInput(index)}>
  //           <DelIcon />
  //         </button>
  //       </div>
  //     ),
  //   );
  const inputElementsRight = groupAssigmentData.rightBoxItems
    ? Object.entries(groupAssigmentData.rightBoxItems).map(([index, value]) => (
        <div className='elem mb1' key={`seqelemright-${index}`}>
          <span className='mr1'>{`Element #${parseInt(index) + 1}:`}</span>
          <input
            type='text'
  ...
  return (
    <div className=''>
      <div className='d-flex jcsb mb4 mt2 g3'>
        <div className=''>
          <div className='mb1'>
            Fill items for <span className='accent'>left</span> box:
          </div>
          <div className='mb4'>
            <span className='mr1 accent2 '>Left box title</span>
            <input
              type='text'
          ...
          <button className='link d-flex jcsb aic g1' onClick={handleAddLeftInput}>
            <AddIcon /> <span className='ml1'>Add new Element</span>
          </button>
        </div>
        <div className=''>
          <div className='mb1'>
            Fill items for <span className='accent'>right</span> box:
          </div>
          <div className='mb4'>
            <span className='mr1 accent2 '>Right box title</span>
            <input
              type='text'
          ...
          <button className='link d-flex jcsb aic g1' onClick={handleAddRightInput}>
            <AddIcon /> <span className='ml1'>Add new Element</span>
          </button>
        </div>
      </div>
      ...
      <button className='btn_blue active mt2 mb2' onClick={handleSaveData}>
