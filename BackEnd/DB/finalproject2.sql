...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2023 at 10:59 PM
...
INSERT INTO `class` (`id_class`, `class_name`, `class_level`, `id_teacher`, `id_classFolder`) VALUES
(3, '1b', 1, 111, 1);
...
CREATE TABLE `task` (
  ...
  `task_avatar` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `task` (`id_task`, `task_name`, `create_date`, `task_inner`, `count_points`, `id_teacher`, `id_class`, `id_taskTemplate`, `id_category`, `task_avatar`) VALUES
(1, 'testtask', '2023-06-07 20:50:38', 'dsadsadsadsad', 12, 12, 3, 1, 1, 'avatartest');
...
(108, 'teacher', 'asd@asd.asd', '$2b$10$8fQRtrOiBWU/pWLKVbunEOQosr/dKrkRpMRkwcMjgkuCskQFXW30G', 'adse', 'agronvv', 'avatar-2.svg'),
...
ALTER TABLE `class`
  ...
  ADD UNIQUE KEY `id_classFolder` (`id_classFolder`),
...
--
ALTER TABLE `class`
  MODIFY `id_class` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `user`
  MODIFY `id_user` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `task`
  ADD CONSTRAINT `task_ibfk_1` FOREIGN KEY (`id_class`) REFERENCES `class` (`id_class`) ON DELETE CASCADE ON UPDATE CASCADE;
